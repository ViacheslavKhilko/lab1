        ...
        child: ListView(
          children: <Widget>[
            Column(
              ...
              children: <Widget>[
                Image.asset("img/1.jpg", fit: BoxFit.fill),
                    ...
                    children:<Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              IconButton(onPressed: likeReact, icon: Icon(Icons.favorite, color: StateLike ?Colors.red[500] : Colors.grey[500],),),
                              Text('$LikeCount'),
                            ],
                          ),
                        ],
                      ...
                      Row(
                        ...
                        children: <Widget> [
                          ...
                          Column(
                            children: <Widget>[
                              IconButton(onPressed: () => launch('https://www.google.com/maps/search/?api=1&query=45.05030994296792,38.92070860447134'), icon: Icon(Icons.near_me, color: Colors.green[500],),),
                              Text('МАРШРУТ', style: TextStyle(color:Colors.green,),),
                            ],
                          ),
                          Column(
                            children: <Widget>[
                              IconButton(onPressed: () => Share.share('https://www.google.com/maps/search/?api=1&query=45.05030994296792,38.92070860447134'), icon: Icon(Icons.share, color: Colors.green[500],),),
